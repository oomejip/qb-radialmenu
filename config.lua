    ...
    ["police"] = {
        {
            ...
            id = 'checkvehstatus',
            title = 'Controleer Tuning Status',
            icon = 'circle-info',
            type = 'client',
